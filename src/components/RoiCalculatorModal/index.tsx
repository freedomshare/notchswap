      ...
      <ScrollableContainer>
        <Flex flexDirection="column" mb="8px">
          ...
          <FullWidthButtonMenu activeIndex={stakingDuration} onItemClick={setStakingDuration} scale="sm">
            <ButtonMenuItem  style={{color:'black'}} variant="tertiary">{t('1D')}</ButtonMenuItem>
            <ButtonMenuItem  style={{color:'black'}} variant="tertiary">{t('7D')}</ButtonMenuItem>
            <ButtonMenuItem  style={{color:'black'}} variant="tertiary">{t('30D')}</ButtonMenuItem>
            <ButtonMenuItem  style={{color:'black'}} variant="tertiary">{t('1Y')}</ButtonMenuItem>
            <ButtonMenuItem  style={{color:'black'}} variant="tertiary">{t('5Y')}</ButtonMenuItem>
          </FullWidthButtonMenu>
              ...
              <Flex alignItems="center">
                ...
                <Flex flex="6">
                  <FullWidthButtonMenu
                    ...
                    scale="sm"
                  >
                    <ButtonMenuItem style={{color:'black'}}>{t('1D')}</ButtonMenuItem>
                    <ButtonMenuItem style={{color:'black'}}>{t('7D')}</ButtonMenuItem>
                    <ButtonMenuItem style={{color:'black'}}>{t('14D')}</ButtonMenuItem>
                    <ButtonMenuItem style={{color:'black'}}>{t('30D')}</ButtonMenuItem>
                  </FullWidthButtonMenu>
                </Flex>
              </Flex>
            </>
